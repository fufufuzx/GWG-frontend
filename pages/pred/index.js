      ...
      {rounds.length > 0 ? (
        <div className='flex flex-col items-center justify-center mt-8 w-full'>
          <div className='flex items-center justify-center w-full max-w-4xl'>
            ...
            <div className={`bg-gray-900 border-2 p-4 m-2 w-full md:w-96 shadow-lg transition-transform transform ${animating ? (direction === 'right' ? 'translate-x-full opacity-0' : '-translate-x-full opacity-0') : 'translate-x-0 opacity-100'} text-center`}>
